...
export default function Home() {
  ...
  return <main className="site-shell">
    ...
    <section className="section services" id="services"><div className="container"><div className="section-intro"><SectionLabel>WHAT WE DO</SectionLabel><h2>Built for the<br /><span>travel industry.</span></h2><p>Specialized Google Ads campaigns designed around how travellers search, compare and book.</p></div><div className="services-grid">{services.map(([title, text, Icon], i) => <article className="service-card" key={title} style={{ "--i": i } as React.CSSProperties}><div className="icon-box"><Icon size={21} /></div><h3>{title}</h3><p>{text}</p><a href="#contact">Learn more <ArrowRight size={16} /></a></article>)}</div></div></section>
